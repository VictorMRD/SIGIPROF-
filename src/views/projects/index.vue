  ...
  <div class="p-8">
    ...
    <div class="py-4 flex flex-col gap-4">
      <div class="flex justify-between">
        <p class="text-3xl font-semibold">Proyectos</p>
        ...
        <div class="flex flex-col gap-2">
          ...
          <div className="container sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-6">
              <Card
                className="bg-white dark:bg-gray-950 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300"
                v-for="document in paginatedInformation"
              >
                <CardContent className="p-6 space-y-4">
                  <div className="flex items-center justify-between">
                    <h3 className="text-lg font-semibold w-1/2">{{ document.titulo }}</h3>
                    <div
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    This is a sample project description that showcases the key details of the
                    project.
                  </p>
                </CardContent>
              </Card>
